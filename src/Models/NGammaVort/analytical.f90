...
!               f(:,1) = (2*D*a**2*sin(a*x)*sin(a*y) + D*a**2*x**2*sin(a*x)*sin(a*y) + D*a**2*xc**2*sin(a*x)*sin(a*y) + D*a**2*y**2*sin(a*x)*sin(a*y) + D*a**2*yc**2*sin(a*x)*sin(a*y) - D*a*x*cos(a*x)*sin(a*y) + D*a*xc*cos(a*x)*sin(a*y) - D*a*y*cos(a*y)*sin(a*x) + D*a*yc*cos(a*y)*sin(a*x) - 2*D*a**2*x*y*cos(a*x)*cos(a*y) + 2*D*a**2*x*yc*cos(a*x)*cos(a*y) + 2*D*a**2*xc*y*cos(a*x)*cos(a*y) - 2*D*a**2*xc*yc*cos(a*x)*cos(a*y) - 2*D*a**2*x*xc*sin(a*x)*sin(a*y) - 2*D*a**2*y*yc*sin(a*x)*sin(a*y) + 2*a*x*cos(a*x)*sin(a*y)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - 2*a*xc*cos(a*x)*sin(a*y)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - 2*a*y*cos(a*y)*sin(a*x)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + 2*a*yc*cos(a*y)*sin(a*x)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - a*x*cos(a*x)*cos(a*y)**2*sin(a*x)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + a*xc*cos(a*x)*cos(a*y)**2*sin(a*x)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + a*y*cos(a*x)**2*cos(a*y)*sin(a*y)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - a*yc*cos(a*x)**2*cos(a*y)*sin(a*y)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + a*x*cos(a*x)*sin(a*x)*sin(a*y)**2*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - a*xc*cos(a*x)*sin(a*x)*sin(a*y)**2*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - a*y*cos(a*y)*sin(a*x)**2*sin(a*y)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + a*yc*cos(a*y)*sin(a*x)**2*sin(a*y)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5))/((x - xc)**2 + (y - yc)**2 + 1)

!            f(:,2) = - mu*(((y - yc)*((a*cos(a*x)*cos(a*y)**2*sin(a*x) - a*cos(a*x)*sin(a*y)*(sin(a*x)*sin(a*y) + 2))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((x - xc)*(a**2*cos(a*x)**2*cos(a*y)**2 - a**2*cos(a*x)**2*sin(a*y)**2 - a**2*cos(a*y)**2*sin(a*x)**2 + a**2*sin(a*x)*sin(a*y)*(sin(a*x)*sin(a*y) + 2)))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((a**2*cos(a*x)*cos(a*y)*(sin(a*x)*sin(a*y) + 2) + 3*a**2*cos(a*x)*cos(a*y)*sin(a*x)*sin(a*y))*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - ((2*x - 2*xc)*(a*cos(a*x)*cos(a*y)**2*sin(a*x) - a*cos(a*x)*sin(a*y)*(sin(a*x)*sin(a*y) + 2))*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + ((2*x - 2*xc)*(a*cos(a*x)**2*cos(a*y)*sin(a*y) - a*cos(a*y)*sin(a*x)*(sin(a*x)*sin(a*y) + 2))*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((x - xc)*((a*cos(a*x)**2*cos(a*y)*sin(a*y) - a*cos(a*y)*sin(a*x)*(sin(a*x)*sin(a*y) + 2))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((y - yc)*(a**2*cos(a*x)**2*cos(a*y)**2 - a**2*cos(a*x)**2*sin(a*y)**2 - a**2*cos(a*y)**2*sin(a*x)**2 + a**2*sin(a*x)*sin(a*y)*(sin(a*x)*sin(a*y) + 2)))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((a**2*cos(a*x)*cos(a*y)*(sin(a*x)*sin(a*y) + 2) + 3*a**2*cos(a*x)*cos(a*y)*sin(a*x)*sin(a*y))*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((2*y - 2*yc)*(a*cos(a*x)*cos(a*y)**2*sin(a*x) - a*cos(a*x)*sin(a*y)*(sin(a*x)*sin(a*y) + 2))*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) - ((2*y - 2*yc)*(a*cos(a*x)**2*cos(a*y)*sin(a*y) - a*cos(a*y)*sin(a*x)*(sin(a*x)*sin(a*y) + 2))*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - ((2*x - 2*xc)*(((a*cos(a*x)*cos(a*y)**2*sin(a*x) - a*cos(a*x)*sin(a*y)*(sin(a*x)*sin(a*y) + 2))*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - ((a*cos(a*x)**2*cos(a*y)*sin(a*y) - a*cos(a*y)*sin(a*x)*(sin(a*x)*sin(a*y) + 2))*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + ((2*y - 2*yc)*(((a*cos(a*x)*cos(a*y)**2*sin(a*x) - a*cos(a*x)*sin(a*y)*(sin(a*x)*sin(a*y) + 2))*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - ((a*cos(a*x)**2*cos(a*y)*sin(a*y) - a*cos(a*y)*sin(a*x)*(sin(a*x)*sin(a*y) + 2))*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) - 2*a**2*cos(a*x)*cos(a*y)*(sin(a*x)*sin(a*y) + 2) - 6*a**2*cos(a*x)*cos(a*y)*sin(a*x)*sin(a*y)) - ((a*k*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*k*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (cos(a*x)**2*cos(a*y)**2*(2*x - 2*xc)*(sin(a*x)*sin(a*y) + 2)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) - (cos(a*x)**2*cos(a*y)**2*(2*y - 2*yc)*(sin(a*x)*sin(a*y) + 2)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*cos(a*x)**2*cos(a*y)**3*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)**3*cos(a*y)**2*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (2*a*cos(a*x)**2*cos(a*y)*sin(a*y)*(sin(a*x)*sin(a*y) + 2)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (2*a*cos(a*x)*cos(a*y)**2*sin(a*x)*(sin(a*x)*sin(a*y) + 2)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))

!f(:,3) = DparN*(((y - yc)*((a*cos(a*y)*sin(a*x))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*sin(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*cos(a*x)*cos(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*y)*sin(a*x)*(2*x - 2*xc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*cos(a*x)*sin(a*y)*(2*x - 2*xc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((sin(a*x)*sin(a*y) + 2)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5)) + ((x - xc)*((a*cos(a*x)*sin(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*sin(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*cos(a*x)*cos(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*y)*sin(a*x)*(2*y - 2*yc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) - (a*cos(a*x)*sin(a*y)*(2*y - 2*yc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((sin(a*x)*sin(a*y) + 2)*((x - xc)**2 + (y - yc)**2 + 1)**(0.5)) - ((2*x - 2*xc)*((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/(2*(sin(a*x)*sin(a*y) + 2)*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + ((2*y - 2*yc)*((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/(2*(sin(a*x)*sin(a*y) + 2)*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*cos(a*y)*sin(a*x)*((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/((sin(a*x)*sin(a*y) + 2)**2*((x - xc)**2 + (y - yc)**2 + 1)**(0.5)) - (a*cos(a*x)*sin(a*y)*((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/((sin(a*x)*sin(a*y) + 2)**2*((x - xc)**2 + (y - yc)**2 + 1)**(0.5))) - ((a*cos(a*x)**2*cos(a*y)**2*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)**2*sin(a*y)**2*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (cos(a*x)**2*cos(a*y)*sin(a*y)*(2*x - 2*xc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) - (cos(a*x)**2*cos(a*y)*sin(a*y)*(2*y - 2*yc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (2*a*cos(a*x)*cos(a*y)*sin(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5)) + Dw*(((y - yc)*((a**2*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*cos(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a**2*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*x)*cos(a*y)*(2*x - 2*xc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*sin(a*x)*sin(a*y)*(2*x - 2*xc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + 2*a**2*cos(a*x)*sin(a*y) - ((x - xc)*((a**2*cos(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*sin(a*x)*sin(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a**2*cos(a*y)*sin(a*x)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*x)*cos(a*y)*(2*y - 2*yc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*sin(a*x)*sin(a*y)*(2*y - 2*yc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((2*x - 2*xc)*((a*cos(a*x)*cos(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*sin(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) - ((2*y - 2*yc)*((a*cos(a*x)*cos(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*sin(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))) + DparPhi*(((x - xc)*((a**2*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a**2*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*cos(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*x)*cos(a*y)*(2*y - 2*yc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*sin(a*x)*sin(a*y)*(2*y - 2*yc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - ((y - yc)*((a**2*cos(a*y)*sin(a*x)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a**2*cos(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*sin(a*x)*sin(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*x)*cos(a*y)*(2*x - 2*xc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*sin(a*x)*sin(a*y)*(2*x - 2*xc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - ((2*x - 2*xc)*((a*cos(a*x)*cos(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*sin(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + ((2*y - 2*yc)*((a*cos(a*x)*cos(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*sin(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)))

!f(:,4) =DnDivn*((a**2*sin(a*x)*sin(a*y) - ((y - yc)*((a*cos(a*y)*sin(a*x))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*sin(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*cos(a*x)*cos(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*y)*sin(a*x)*(2*x - 2*xc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*cos(a*x)*sin(a*y)*(2*x - 2*xc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + ((2*x - 2*xc)*((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)))/(sin(a*x)*sin(a*y) + 2) - (((x - xc)*((a*cos(a*x)*sin(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*sin(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a**2*cos(a*x)*cos(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*y)*sin(a*x)*(2*y - 2*yc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) - (a*cos(a*x)*sin(a*y)*(2*y - 2*yc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - a**2*sin(a*x)*sin(a*y) + ((2*y - 2*yc)*((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)))/(sin(a*x)*sin(a*y) + 2) + (a*cos(a*y)*sin(a*x)*(a*cos(a*y)*sin(a*x) - (((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5)))/(sin(a*x)*sin(a*y) + 2)**2 + (a*cos(a*x)*sin(a*y)*(a*cos(a*x)*sin(a*y) + (((a*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5)))/(sin(a*x)*sin(a*y) + 2)**2) + DPhi*(((x - xc)*((a**2*cos(a*x)*sin(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a**2*cos(a*y)*sin(a*x)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*cos(a*x)*cos(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*x)*cos(a*y)*(2*y - 2*yc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*sin(a*x)*sin(a*y)*(2*y - 2*yc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + 2*a**2*cos(a*y)*sin(a*x) - ((y - yc)*((a**2*cos(a*y)*sin(a*x)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a**2*cos(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - (a*sin(a*x)*sin(a*y))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*cos(a*x)*cos(a*y)*(2*x - 2*xc)*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + (a*sin(a*x)*sin(a*y)*(2*x - 2*xc)*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) - ((2*x - 2*xc)*((a*cos(a*x)*cos(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*sin(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(y - yc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5)) + ((2*y - 2*yc)*((a*cos(a*x)*cos(a*y)*(y - yc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5) + (a*sin(a*x)*sin(a*y)*(x - xc))/((x - xc)**2 + (y - yc)**2 + 1)**(0.5))*(x - xc))/(2*((x - xc)**2 + (y - yc)**2 + 1)**(1.5))) + cos(a*x)*sin(a*y)
