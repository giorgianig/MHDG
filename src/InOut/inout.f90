...
CONTAINS
  ...
  contains
    ...
    subroutine save_simulation_parameters()
      ...
      call HDF5_real_saving(group_id2, phys%diff_nn, 'diff_nn')
	     ...
	     IF (switch%ME) THEN
	        call HDF5_array1d_saving(group_id2, phys%puff_exp, time%nts, 'puff_exp')
                call HDF5_array1d_saving(group_id2, phys%n_li, time%nts, 'n_li')
                call HDF5_array1d_saving(group_id2, phys%n_lit, time%nts, 'n_lit')
	     END IF
      ...
      call HDF5_integer_saving(group_id2, switch%pinch, 'pinch')
  ...
  subroutine HDF5_load_solution(fname)
    ...
    IF (switch%ME) THEN
       ...
       IF (time%it .ne. 0) THEN
          ...
          CALL HDF5_array1D_reading(group_id2, phys%n_li, 'n_li')
