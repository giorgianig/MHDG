...
!     integer,allocatable   :: connpro(:)        ! processes connected to the local process
  ...
  END TYPE Mesh_type
   ...
   TYPE Physics_type
      ...
      real*8,pointer :: Br(:)        ! Magnetic field (tesla) in the r direction [n of nodes]
      real*8,pointer :: Bz(:)        ! Magnetic field (tesla) in the z direction [n of nodes] 
      real*8,pointer :: Bt(:)        ! Magnetic field (tesla) in the t direction [n of nodes]  
