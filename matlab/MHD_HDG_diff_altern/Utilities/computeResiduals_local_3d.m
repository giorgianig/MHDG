function residual = computeResiduals_local_3d...
    (Fcon,F_dir,flipFace,u_tilde,u,q,A,G,Cv,D,E,Edir,H,Hdir,force,...
...
%         indL = (iElem-1)*neq*Nv*nd + (1:neq*Nv*nd);
        ...
        indq = (iElem-1)*neq*Nv*3 + (1:neq*Nv*3);
...
%         end
        ...
        residual(2,iElem) = norm( (-Cve+De+Ge-((Pe-Pbe)-(Qe-Qbe))*invLe*Be)*ue+...
            (He-Ee+((Pe-Pbe)-(Qe-Qbe))*invLe*Ce)*ue_tilde+...
