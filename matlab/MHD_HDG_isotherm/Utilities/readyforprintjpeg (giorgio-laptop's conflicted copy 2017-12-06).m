...
function readyforprintjpeg(wh,fs,fgcin,bgcin,lw,fh,ms,name)
...
defaults.axes_props.FontName ='times new roman';
...
defaults.colorbar_props.FontSize = fs;
defaults.colorbar_props.FontName = 'times new roman';
...
print('-djpeg','-r300',['/home/giorgio/Dropbox/PostDoc_Marseille/Latex/Paper_HDG/figures/figure_2107/' name '.jpg'])
system(['convert /home/giorgio/Dropbox/PostDoc_Marseille/Latex/Paper_HDG/figures/figure_2107/'  name '.jpg -trim /home/giorgio/Dropbox/PostDoc_Marseille/Latex/Paper_HDG/figures/figure_2107/' name '.jpg'])
