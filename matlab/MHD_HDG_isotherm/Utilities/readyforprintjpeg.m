...
function readyforprintjpeg(wh,fs,fgcin,bgcin,lw,fh,ms,path,name)
...
print('-djpeg','-r600',[path name '.jpg'])
system(['convert ' path name '.jpg -trim ' path  name '.jpg'])
% system(['convert ' path name '.jpg -crop 1200x1550+650+80 ' path  name '.jpg'])
