...
//+
Transfinite Curve {2, 4, 7, 8, 19, 20} = 11 Using Progression 1;
//+
Transfinite Curve {1, 5, 6, 9, 13, 14, 15, 16} = 21 Using Progression 1;
//+
Transfinite Curve {10, 11, 12, 17, 18} = 5 Using Progression 1;
//+
...
//+
Transfinite Surface {1} = {2, 5, 15, 7};
//+
Transfinite Surface {3};
//+
Transfinite Surface {3} = {7, 8, 14, 13};
//+
Transfinite Surface {4};
//+
Transfinite Surface {4} = {8, 7, 13, 14};
//+
