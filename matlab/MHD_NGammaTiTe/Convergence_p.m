...
for ip =1:np
    ...
    [M,B,C,C_dir,G,D,E,Df,Ef,Edir,PQinvL,invL,force,Lf] =...
        hdg_PrecalculatedMatrices(X,T,flipFace,refEl,tau,F_dir);
    ...
    for iStep = 1:nStep
        ...
        for iter = 1:maxIter
            ...
            [LL,LL0,UU,UU0] = hdg_Mapping(flipFace,Nv,nv,M,G,Cv,H,Hdir,D,E,Edir,dt,u0,force,...
                B,C,C_dir,PQinvL,invL);
            
            % Impose boundary condition of the global problem
            [Df,Ef,Hf,Lf,fH] = hdg_bc(Df,Ef,Hf,Lf,X,T,infoFaces,refEl,boundaryNames,F,u_tilde);
            
            % Assembly
            [K,f] = hdg_Assembly(F,nv,LL,LL0,UU,UU0,Df,Ef,Lf,Hf,fH,F_dir,nIntFaces);
            ...
            u = calculateElementByElementSolution(u_tilde,F,U,U0);
