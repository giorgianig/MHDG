...
%                 stop
        ...
        % stop
        % Assembly
        [K,f,errk,errf] = hdg_Assembly(F,nv,LL,LL0,UU,UU0,Df,Ef,Lf+Lf_locDiffPts+Lf_sc+Lf_limRho,...
...
figure
subplot(2,2,1),plotSolution(X,T,u(1:4:end-3),refEl,20); title('U1')
subplot(2,2,2),plotSolution(X,T,u(2:4:end-2),refEl,20); title('U2')
subplot(2,2,3),plotSolution(X,T,u(3:4:end-1),refEl,20); title('U3')
subplot(2,2,4),plotSolution(X,T,u(4:4:end),refEl,20);    title('U4')
